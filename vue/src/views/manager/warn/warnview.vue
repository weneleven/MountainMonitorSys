          ...
          <div>
            ...
            <div class="card" style="margin-bottom: 10px">
              ...
              <el-table :data="pagedTableData" stripe>
                ...
                <el-table-column label="sum_xy" prop="today_combinexy"></el-table-column>
                ...
                <el-table-column label="sum_h" prop="today_combineh"></el-table-column>
                ...
                <el-table-column label="angle_xy" prop="xya"></el-table-column>
                <el-table-column label="angle_h" prop="ha"></el-table-column>
                <el-table-column label="warn_xy" prop="xy_warn_info"></el-table-column>
                <!-- <el-table-column label="xy_flag" prop="xy_flag"></el-table-column> -->
                <el-table-column label="warn_h" prop="h_warn_info"></el-table-column>
